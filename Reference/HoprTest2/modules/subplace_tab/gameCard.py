...
class Ui_GameCard(object):
    ...
    def retranslateUi(self, GameCard):
        ...
        self.updatedLabel.setText(QCoreApplication.translate("GameCard", u"Updated:", None))
        self.createdLabel.setText(QCoreApplication.translate("GameCard", u"Created:", None))
